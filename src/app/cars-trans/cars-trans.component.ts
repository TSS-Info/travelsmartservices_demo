...
export class CarsTransComponent implements OnInit {
  ...
  submitDetails(){
    ...
    totalHours: this.totalHours, journey: this.journey, customerName: this.mainCustomerName, costOfFuelPerLtr: this.fuelCost, guestPhoneNo: this.guestPhoneNo, bookedBy: this.bookedBy};
